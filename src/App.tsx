...
function App() {
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/3780030/pexels-photo-3780030.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", // reused image
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            <Card className="bg-black/40 border-purple-500/20 p-8 hover:border-purple-500/40 transition-all">
              ...
              >
                Get Your Free AI Prototype Now
              </Button>
            </Card>

            {/* Lead Generation AI Card - Made Larger */}
...
Start generating qualified leads daily—automatically, consistently, and at scale.
              ...
              <Button 
                className="w-full bg-purple-600 hover:bg-purple-700 text-md py-5"
                onClick={() => setOpenContactForm(true)}
              >
                Book your Demo Call
              </Button>
    ...
    <div className="max-w-3xl mx-auto">
      <Accordion type="single" collapsible className="space-y-4">
        ...
        <AccordionItem value="item-2" className="border-purple-500/20 px-6">
          ...
          <AccordionContent className="text-gray-400">
            Yes, we offer both options depending on your needs. With <strong>full ownership</strong>, you purchase the entire AI system and receive training before we hand it off — it's yours to manage. However, while () {
              
            }ith <strong>monthly retainers</strong>, you get a hands-off experience where we handle everything — from operation to maintenance — while you pay a monthly fee.
          </AccordionContent>
        </AccordionItem>
